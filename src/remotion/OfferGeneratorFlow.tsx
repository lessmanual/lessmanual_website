...
const elements: FlowElement[] = [
  // inputs (left cluster)
  { id: 0, label: "CHAT",     sublabel: "AI dialog",  color: "#525252", chaosX: -160, chaosY: -150, chaosRotate: -20, chaosScale: 0.7,  orderX: -150, orderY: -110, delay: 0 },
  { id: 1, label: "FORM",     sublabel: "konfigurator", color: "#525252", chaosX: 140, chaosY: -190, chaosRotate: 22, chaosScale: 0.8,  orderX: -150, orderY: 0,    delay: 2 },
  { id: 2, label: "QR CODE",  sublabel: "showroom",   color: "#525252", chaosX: -80,  chaosY: 170,  chaosRotate: -28, chaosScale: 0.65, orderX: -150, orderY: 110,  delay: 4 },
  // central AGENT
  { id: 3, label: "AGENT",    sublabel: "CALC + RAG + TEMPLATES", color: ACCENT, chaosX: 10, chaosY: -50, chaosRotate: 0, chaosScale: 0.5, orderX: 0, orderY: 0, delay: 3 },
  // outputs (right cluster)
  { id: 4, label: "PDF WYSŁANY",    sublabel: "5 min",    color: "#525252", chaosX: 150,  chaosY: 120,  chaosRotate: 25,  chaosScale: 0.7,  orderX: 150, orderY: -110, delay: 1 },
  { id: 5, label: "AUTO FOLLOW-UP", sublabel: "D3 + D7", color: "#525252", chaosX: -130, chaosY: -55,  chaosRotate: -15, chaosScale: 0.75, orderX: 150, orderY: 0,    delay: 3 },
  { id: 6, label: "TRACKING",       sublabel: "otwarcia", color: "#525252", chaosX: 80,  chaosY: -140, chaosRotate: 18,  chaosScale: 0.6,  orderX: 150, orderY: 110,  delay: 5 },
];
...
export const OfferGeneratorFlow: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();
