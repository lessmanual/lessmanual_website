...
/**
 * Variant 1: Scattered Papers
 * Pomięte, obrócone kartki z "odręcznymi" liniami tekstu
 * → organizują się w schludny stos dokumentów
 */
...
const papers: Paper[] = [
  { id: 0, chaosX: -140, chaosY: -160, chaosRotate: -32, chaosScale: 0.75, orderX: -8, orderY: -80, orderRotate: -1.5, delay: 0, lines: [0.8, 0.6, 0.9, 0.4], accent: false },
  { id: 1, chaosX: 160,  chaosY: -130, chaosRotate: 22,  chaosScale: 0.65, orderX: -4, orderY: -72, orderRotate: 0.8,  delay: 1, lines: [0.7, 0.85, 0.5, 0.65, 0.3], accent: false },
  { id: 2, chaosX: -100, chaosY: 170,  chaosRotate: -45, chaosScale: 0.7,  orderX: 0,  orderY: -64, orderRotate: -0.5, delay: 2, lines: [0.9, 0.55, 0.75], accent: false },
  { id: 3, chaosX: 130,  chaosY: 140,  chaosRotate: 38,  chaosScale: 0.6,  orderX: 4,  orderY: -56, orderRotate: 0.3,  delay: 3, lines: [0.6, 0.8, 0.45, 0.7, 0.55, 0.3], accent: true },
  { id: 4, chaosX: -170, chaosY: 20,   chaosRotate: 15,  chaosScale: 0.8,  orderX: 0,  orderY: -48, orderRotate: -0.2, delay: 4, lines: [0.75, 0.5, 0.85, 0.4], accent: false },
  { id: 5, chaosX: 50,   chaosY: -200, chaosRotate: -28, chaosScale: 0.55, orderX: -2, orderY: -40, orderRotate: 0.6,  delay: 5, lines: [0.65, 0.9, 0.5], accent: false },
  { id: 6, chaosX: -50,  chaosY: -60,  chaosRotate: 50,  chaosScale: 0.7,  orderX: 2,  orderY: -32, orderRotate: -0.8, delay: 2, lines: [0.8, 0.7, 0.6, 0.85], accent: false },
];
...
function PaperSheet({
  ...
  // Organized stack: subtle paper edge offset
          ...
          style={{
            ...
            background:
              paper.accent && i === 0 && progress > 0.8
                ? ACCENT
                : `rgba(30, 41, 59, ${0.08 + Math.random() * 0.04})`,
            transition: "background 0.5s",
          }}
        />
      ))}

      {/* Accent checkmark when organized */}
      {paper.accent && (
        <div
          style={{
            position: "absolute",
...
export const ScatteredPapers: React.FC = () => {
  const frame = useCurrentFrame();
