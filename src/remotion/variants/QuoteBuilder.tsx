...
/**
 * QuoteBuilder — Generator Ofert hero animation
 * Rozrzucone elementy wycen (chaos)
 * → organizują się w uporządkowany system generowania ofert
 */
...
const nodes: QuoteNode[] = [
  // Row 1
  { id: 0, label: "Formularz\nwyceny",   chaosX: -160, chaosY: -140, chaosRotate: -25, orderX: -150, orderY: -120, delay: 0, width: 100, height: 70 },
  { id: 1, label: "Twoje\nceny",         chaosX: 150,  chaosY: -60,  chaosRotate: 18,  orderX: -20,  orderY: -120, delay: 1, width: 100, height: 70 },
  { id: 2, label: "Dane\nklienta",       chaosX: -80,  chaosY: 160,  chaosRotate: -12, orderX: 110,  orderY: -120, delay: 2, width: 100, height: 70 },
  // Row 2
  { id: 3, label: "Kalkulacja\nauto",    chaosX: 140,  chaosY: 120,  chaosRotate: 30,  orderX: -150, orderY: 10,   delay: 3, width: 100, height: 70 },
  { id: 4, label: "PDF\nz logo",         chaosX: -140, chaosY: 50,   chaosRotate: -20, orderX: -20,  orderY: 10,   delay: 3, width: 100, height: 70 },
  { id: 5, label: "Wysyłka\nmailem",     chaosX: 60,   chaosY: -150, chaosRotate: 15,  orderX: 110,  orderY: 10,   delay: 4, width: 100, height: 70 },
  // Result node
  { id: 6, label: "5 min\nzamiast 2h",   chaosX: -50,  chaosY: -30,  chaosRotate: -8,  orderX: -20,  orderY: 130,  delay: 5, width: 130, height: 55 },
];
