...
const elements: FlowElement[] = [
  // Sources (scatter position)
  { id: 0, label: "LINKEDIN\nSALES NAV", color: "#525252", chaosX: -160, chaosY: -190, chaosRotate: -22, chaosScale: 0.7,  orderX: -155, orderY: -110, delay: 0 },
  { id: 1, label: "CLUTCH",             color: "#525252", chaosX: 160,  chaosY: -170, chaosRotate: 18,  chaosScale: 0.8,  orderX: -45,  orderY: -110, delay: 2 },
  { id: 2, label: "CRUNCHBASE",         color: "#525252", chaosX: -90,  chaosY: 190,  chaosRotate: -30, chaosScale: 0.65, orderX: 65,   orderY: -110, delay: 4 },
  { id: 3, label: "KRS",               color: "#525252", chaosX: 180,  chaosY: 90,   chaosRotate: 28,  chaosScale: 0.75, orderX: 175,  orderY: -110, delay: 1 },
  // Central agent
  { id: 4, label: "AGENT",             color: ACCENT,    chaosX: 10,   chaosY: -40,  chaosRotate: 0,   chaosScale: 0.5,  orderX: 10,   orderY: 20,   delay: 3 },
  // Outputs
  { id: 5, label: "WARM\nLEADS",       color: "#525252", chaosX: -150, chaosY: 60,   chaosRotate: 25,  chaosScale: 0.7,  orderX: -130, orderY: 145,  delay: 5, isOutput: true },
  { id: 6, label: "SEQUENCES\nSENT",   color: "#525252", chaosX: 80,   chaosY: -130, chaosRotate: -18, chaosScale: 0.6,  orderX: 10,   orderY: 145,  delay: 5, isOutput: true },
  { id: 7, label: "MEETINGS\nBOOKED",  color: "#525252", chaosX: 130,  chaosY: 180,  chaosRotate: -25, chaosScale: 0.7,  orderX: 150,  orderY: 145,  delay: 5, isOutput: true },
];

// Sources to AGENT, AGENT to outputs
const connectionsIn: [number, number][] = [[0, 4], [1, 4], [2, 4], [3, 4]];
const connectionsOut: [number, number][] = [[4, 5], [4, 6], [4, 7]];
  ...
  return (
    <div
      style={{
        ...
        width: isCenter ? 118 : 100,
        padding: isCenter ? "14px 10px" : "9px 8px",
...
export const PipelineMachineFlow: React.FC = () => {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();
  ...
  return (
    ...
    >
      ...
      {/* Connection lines: sources to AGENT */}
      <svg
        style={{
          position: "absolute",
          left: "50%",
      ...
      >
        agent · pipeline · 76% open · 61% reply
      </div>
    </AbsoluteFill>
  );
};
