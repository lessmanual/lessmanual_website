...
**Wersja:** 1.0
**Data wejścia w życie:** 30 października 2025
...
2. [Zakres Przetwarzanych Danych](#2-zakres-przetwarzanych-danych)
3. [Cele i Podstawy Prawne Przetwarzania](#3-cele-i-podstawy-prawne-przetwarzania)
4. [Odbiorcy Danych Osobowych](#4-odbiorcy-danych-osobowych)
5. [Przekazywanie Danych Poza EOG](#5-przekazywanie-danych-poza-eog)
6. [Okres Przechowywania Danych](#6-okres-przechowywania-danych)
7. [Prawa Osób, Których Dane Dotyczą](#7-prawa-osób-których-dane-dotyczą)
8. [Jak Skorzystać z Praw](#8-jak-skorzystać-z-praw)
9. [Środki Bezpieczeństwa](#9-środki-bezpieczeństwa)
10. [Profilowanie i Zautomatyzowane Decyzje](#10-profilowanie-i-zautomatyzowane-decyzje)
11. [Pliki Cookies](#11-pliki-cookies)
12. [Zmiany Polityki](#12-zmiany-polityki)
13. [Szczególne Postanowienia dla Polski](#13-szczególne-postanowienia-dla-polski)
14. [Postanowienia Końcowe](#14-postanowienia-końcowe)
15. [Podsumowanie i Kontakt](#15-podsumowanie-i-kontakt)
...
**Szczegóły:** Zobacz sekcję [4.3 Administrator vs Procesor](#43-administrator-vs-procesor)
...
- Kliknij "Unsubscribe" w emailu
- Napisz do nas: kontakt@lessmanual.ai
...
- Kliknij "Unsubscribe" w każdym newsletterze
- Napisz do nas: kontakt@lessmanual.ai
...
**Jak wnieść sprzeciw:**
- Email: kontakt@lessmanual.ai
- Link "Unsubscribe" w każdym emailu marketingowym
...
**Jak cofnąć zgodę:**
- Link "Unsubscribe" w newsletterze
- Email: kontakt@lessmanual.ai
...
📝 Formularz online: https://uodo.gov.pl/pl/p/skarga
...
**📧 Email (preferowany):** kontakt@lessmanual.ai
**✉️ Poczta:** Bartłomiej Chudzik, LessManual.ai, Cendrowice, 05-530, Polska
...
**Definicja profilowania (art. 4 pkt 4 RODO):**
...
**Prawo sprzeciwu:**
- **TAK** - kontakt: kontakt@lessmanual.ai
...
**Definicja w pełni zautomatyzowanej decyzji (art. 22 ust. 1 RODO):**
...
**[Polityka Cookies LessManual.ai](/legal/polityka-cookies)**
...
📞 Telefon: +48 22 531 03 00
🌐 Strona internetowa: https://uodo.gov.pl
📝 Formularz skargi online: https://uodo.gov.pl/pl/p/skarga
...
📧 **Email:** kontakt@lessmanual.ai
🌐 **Strona internetowa:** https://lessmanual.ai
...
**📧 Email:** kontakt@lessmanual.ai (Subject: "RODO - [Twoje pytanie]")
**✉️ Poczta:** Bartłomiej Chudzik, LessManual.ai, Cendrowice, 05-530, Polska
