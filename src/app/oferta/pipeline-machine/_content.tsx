...
const PIPELINE_SCRIPT: Line[] = [
  ...
  { kind: "out", text: "Claude drafting 312 personalized emails · 2 sequences", tone: "muted", delay: 400 },
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#E5E5E5] border border-[#E5E5E5]">
              {[
                ...
                },
                {
                  ...
                  desc: "Claude pisze spersonalizowanego cold maila dla każdego kontaktu (nie szablon blast). Kontekst: branża, stanowisko, competitor displacement. 1-2 sekwencje z follow-upami. Tone of voice konfigurowalny pod Twoją markę.",
                },
                {
                  num: "03",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div>
                  ...
                  <p className="text-[16px] leading-[1.7] text-[#525252]">
                    Full Pipeline: scraping decydentów z LinkedIn Sales Nav + Crunchbase pod ICP ITAD enterprise. Claude pisze personalizowane cold maile (tech-to-tech tone). Wysyłka przez Instantly na 3 domenach. Agent monitoruje odpowiedzi i umawia spotkania.
                  </p>
                </div>
