...
import { EmailPipeline } from "@/remotion/variants/EmailPipeline";
          ...
          <motion.div variants={stagger} initial="hidden" animate="visible">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_440px] gap-10 lg:gap-14 items-center">
              <div>
                ...
                >
                  <Button href={AI_SDR_CALENDLY_URL} variant="primary" external className="!px-11 !py-5 !text-xl">
                    Chcę umawiać spotkania w kalendarzu
                  </Button>
