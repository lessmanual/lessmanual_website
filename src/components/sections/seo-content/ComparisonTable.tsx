        ...
        <FadeUp delay={0.1}>
          ...
          <div className="overflow-x-auto -mx-6 px-6 mb-8">
            <table className="w-full min-w-[700px] border-collapse">
              <thead>
                <tr>
                  <th className="text-left p-3 text-sm font-sans font-semibold text-text-light w-[20%]" />
                  <th className="text-center p-3 text-sm font-sans font-semibold text-text-light w-[20%]">
                    Copywriter
                  </th>
                  <th className="text-center p-3 text-sm font-sans font-semibold text-text-light w-[20%]">
                    Agencja contentowa
                  ...
                  <th className="text-center p-3 text-sm font-sans font-semibold text-accent w-[20%] bg-accent/5 border-t-2 border-x-2 border-accent/20 rounded-t-[6px]">
                    LessManual
                  </th>
                </tr>
              </thead>
        ...
        <FadeUp delay={0.15}>
          ...
          <div className="bg-accent/10 border border-accent/20 rounded-[6px] px-6 py-4 text-center mb-8">
            <p className="text-text font-medium text-sm">
              Jedyny dostawca z gwarancją ROI 200% w 90 dni. Nie dowieziemy? Miesiąc gratis.
            </p>
          </div>
