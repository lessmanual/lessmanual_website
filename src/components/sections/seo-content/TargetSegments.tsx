...
import { Briefcase, ShoppingCart, Code2, MapPin } from "lucide-react";
      ...
      <div className="max-w-[1000px] mx-auto px-6">
        ...
        <FadeUp delay={0.2}>
          <div className="text-center">
            <p className="text-lg text-text-secondary mb-4">Twoja branża jest tutaj? Policz, ile możesz zaoszczędzić:</p>
