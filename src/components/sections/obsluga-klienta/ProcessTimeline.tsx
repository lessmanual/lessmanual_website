...
import { OBS_KLIENTA_PROCESS_STEPS, OBS_KLIENTA_CALENDLY_URL } from "@/lib/obsluga-klienta-constants";
    ...
    <section id="proces" className="py-28 md:py-40 bg-bg">
      <div className="max-w-[800px] mx-auto px-6">
        <FadeUp>
          <SectionHeader
            eyebrow="Proces"
            title="Od podpisania do uruchomienia: 7-21 dni"
          />
        </FadeUp>
        ...
        <StaggerContainer staggerDelay={0.1} className="relative mb-12">
          ...
          <div className="space-y-6">
            {OBS_KLIENTA_PROCESS_STEPS.map((step, idx) => (
