...
import { ShoppingCart, Stethoscope, Hotel, Briefcase } from "lucide-react";
import { FadeUp } from "@/components/animations/FadeUp";
import { StaggerContainer, StaggerItem } from "@/components/animations/StaggerContainer";
import { SectionHeader } from "@/components/ui/SectionHeader";
import { Button } from "@/components/ui/Button";
import { OBS_KLIENTA_TARGET_SEGMENTS } from "@/lib/obsluga-klienta-constants";
  ...
  return (
    <section className="py-28 md:py-40 bg-white">
      <div className="max-w-[1000px] mx-auto px-6">
        <FadeUp>
          <SectionHeader eyebrow="Dla kogo" title="Dla jakich firm to działa najlepiej" />
        </FadeUp>

        <StaggerContainer staggerDelay={0.1} className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10">
          {OBS_KLIENTA_TARGET_SEGMENTS.map((seg) => {
        ...
        <FadeUp delay={0.2}>
          <div className="text-center">
            <p className="text-text-secondary mb-4">Twoja branża jest tutaj? Policz, ile tracisz bez systemu:</p>
